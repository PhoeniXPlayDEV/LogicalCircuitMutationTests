...
public class CustomMutation14 extends LogicalCircuitCreator {
    ...
    public LogicalCircuitContainer createLogicalCircuit() {
        ...
        //Changed the argument name from inverterGate2 to inverterGate1
        triggerGate1.setInput(inverterGate1);

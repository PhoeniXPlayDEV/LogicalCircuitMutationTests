...
public class CustomMutation16 extends LogicalCircuitCreator {
    ...
    public LogicalCircuitContainer createLogicalCircuit() {
        ...
        //Changed the argument name from triggerGate2 to triggerGate1
        conjunctionGate2.setInput1(triggerGate1);

...
public class CustomMutation12 extends LogicalCircuitCreator {
    ...
    public LogicalCircuitContainer createLogicalCircuit() {
        ...
        //Changed the argument name from triggerGate1 to triggerGate2
        conjunctionGate1.setInput2(triggerGate2);

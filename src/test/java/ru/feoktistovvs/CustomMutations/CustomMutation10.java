...
public class CustomMutation10 extends LogicalCircuitCreator {
    ...
    public LogicalCircuitContainer createLogicalCircuit() {
        ...
        //Changed the gate type from ConjunctionGate to NANDGate
        NANDGate conjunctionGate2 = new NANDGate();

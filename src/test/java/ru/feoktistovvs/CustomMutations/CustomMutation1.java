...
public class CustomMutation1 extends LogicalCircuitCreator {
    ...
    public LogicalCircuitContainer createLogicalCircuit() {
        ...
        //Changed the gate type from ConjunctionGate to DisjunctionGate
        DisjunctionGate conjunctionGate1 = new DisjunctionGate();
